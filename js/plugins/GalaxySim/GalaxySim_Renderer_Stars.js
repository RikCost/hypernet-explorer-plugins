...
(() => {
  ...
  function generateRealisticStarName(worldX, worldY, seedRng) {
    // i18n-ignore-start  real star catalogue designations and Elite-style
    // procedural sector names; they are identifiers, not words
  ...
  function determineBlackHoleType(worldX, worldY, seedRng, inGreatAttractor = false) {
    if (inGreatAttractor) {
      ...
      // Realistic field population: stellar-mass (normal) black holes are a tiny
      // fraction of stars; supermassive holes appear only as rare rogues.
